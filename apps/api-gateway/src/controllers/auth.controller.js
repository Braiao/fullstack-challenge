...
let AuthController = class AuthController {
    ...
    async register(registerDto) {
        return (0, rxjs_1.lastValueFrom)(this.authClient.send('auth.register', registerDto));
    }
    async login(loginDto) {
        return (0, rxjs_1.lastValueFrom)(this.authClient.send('auth.login', loginDto));
    }
    async refresh(refreshTokenDto) {
        return (0, rxjs_1.lastValueFrom)(this.authClient.send('auth.refresh', refreshTokenDto));
    }
};
